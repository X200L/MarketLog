...
def process_image(img):
    ...
    return result
# проверка работоспособности (для меня)
...
def upload_file():
    ...
    # дальше просто чтобы я могла проверить работу (сайт)
        ...
        <div class="instructions">
            ...
            <ol>
                ...
                <li>Скачайте результат:
                    <ul>
                        <li>Все черные линии станут красными</li>
            ...
            <div class="color-legend">
                <div class="color-item">
                    ...
                    <span>Черные линии (станут красными)</span>
                </div>
                <div class="color-item">
